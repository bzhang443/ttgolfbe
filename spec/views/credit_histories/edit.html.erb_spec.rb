...
describe "credit_histories/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit credit_history form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => credit_histories_path(@credit_history), :method => "post" do
